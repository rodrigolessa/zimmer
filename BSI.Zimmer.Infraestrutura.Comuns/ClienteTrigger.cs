...
public partial class ClienteTrigger
{
    // Enter existing table or view for the target and uncomment the attribute line
    [Microsoft.SqlServer.Server.SqlTrigger(Name = "ClienteTrigger", Target = "Cliente", Event = "AFTER INSERT")]
    public static void TrInsert()
    {
